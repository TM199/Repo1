...
- industry: the company's industry sector (e.g. "Technology", "Healthcare", "Construction", "Financial Services", "Manufacturing", "Retail", "Real Estate", "Education", "Energy", "Legal", "Hospitality", "Logistics")`;
...
- company_domain: the company's website domain without https://${INDUSTRY_INSTRUCTION}
...
- company_domain: their website domain if visible${INDUSTRY_INSTRUCTION}
...
- company_domain: the winner's website domain if visible${INDUSTRY_INSTRUCTION}
...
- company_domain: the company's website domain${INDUSTRY_INSTRUCTION}
...
- company_domain: the company's website domain if visible${INDUSTRY_INSTRUCTION}
...
- company_domain: their website domain${INDUSTRY_INSTRUCTION}
